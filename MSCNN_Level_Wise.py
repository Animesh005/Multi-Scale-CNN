...
train_set = torchvision.datasets.ImageFolder(root="Images/Train", transform=transform)
...
'''test_set = torchvision.datasets.ImageFolder(root="Images/Test", transform=transform)
...
'''train_loader = pickle.load(open("sample_data/train_loader.txt", 'rb'))
val_loader = pickle.load(open("sample_data/val_loader.txt", 'rb'))
test_loader = pickle.load(open("sample_data/test_loader.txt", 'rb'))'''
